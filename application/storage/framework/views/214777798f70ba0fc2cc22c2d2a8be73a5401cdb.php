    ...
    <td class="team_col_action">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo app('translator')->get('lang.send_email'); ?>"
                ...
                data-url="<?php echo e(url('/webmail/compose?view=modal&resource_type=user&resource_id='.$team->id)); ?>"
                data-loading-target="commonModalBody" data-modal-title="<?php echo app('translator')->get('lang.send_email'); ?>"
                data-action-url="<?php echo e(url('/webmail/send')); ?>" data-action-method="POST" data-modal-size="modal-xl"
...
<!--each row--><?php /**PATH /var/www/html/pms.skunktest.work/application/resources/views/pages/team/components/table/ajax.blade.php ENDPATH**/ ?>