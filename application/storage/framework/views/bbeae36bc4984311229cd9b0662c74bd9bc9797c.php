...
<aside class="left-sidebar settings-menu">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a href="javascript:void(0);" data-url="/settings/estimates"
                                ...
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.estimates'))); ?></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-url="/settings/subscriptions"
                                id="settings-menu-billing-subscription"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.subscriptions'))); ?></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-url="/settings/expenses"
                                id="settings-menu-billing-expense"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.expenses'))); ?></a>
                        </li>
                        <li class="hidden">
                            <a href="javascript:void(0);" data-url="/settings/units" id="settings-menu-billing-unit"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.product_units'))); ?></a>
                        </li>
                    </ul>
                </li>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /var/www/html/pms.skunktest.work/application/resources/views/pages/settings/leftmenu-settings.blade.php ENDPATH**/ ?>