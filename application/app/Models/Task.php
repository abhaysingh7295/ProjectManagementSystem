...
class Task extends Model {
    ...
    public function assignSprint() {
        return $this->belongsToMany('App\Models\Sprint', 'sprintassigned_task', 'sprinttask_taskid', 'sprinttask_sprintid');
    }
    ...
    {
        return $this->belongsTo('App\Models\task', 'task_parentid');
    }

    public function children()
    {
        return $this->hasMany('App\Models\task', 'task_parentid');
    }
}
